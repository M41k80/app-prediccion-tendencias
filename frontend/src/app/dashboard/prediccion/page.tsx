...
export default function NuevaPrediccionPage() {
  ...
  const handleGenerar = async () => {
    ...
    try {
      ...
      // Redirigir al dashboard después de una predicción exitosa
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                  ...
                  <div className="space-y-2">
                    <label className="block font-medium">Rango de fechas</label>
                    <div className="relative">
                      <button
                        type="button"
                      ...
                      {isCalendarOpen && (
                        <div
                          ref={calendarRef}
                          className="absolute z-10 mt-1 rounded-md border border-gray-200 bg-white shadow-lg"
                        >
                          <DayPicker
                            mode="range"
                            defaultMonth={today}
                ...
                <div className="text-center">
                  <button
                    ...
                    className="inline-block rounded-lg bg-blue-500 py-2 px-6 text-white font-semibold hover:bg-blue-600 focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
                  >
                    Generar predicción
                  </button>
                </div>
